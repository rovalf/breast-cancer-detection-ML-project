...
# 2. Class weights
# =============================================================================
# Adjust imbalance by giving higher weight to benign samples
...
x = Conv2D(32, (3, 3), activation='relu', kernel_regularizer=l2(1e-4))(inputs)
...
x = Conv2D(128, (3, 3), activation='relu', kernel_regularizer=l2(1e-4))(x)
x = MaxPooling2D(2, 2)(x)
